...
class RandomDogImageNotifier extends ChangeNotifier {
  RandomDogImageNotifier({
    required GetRandomDogImageUseCase getRandomDogImageUseCase,
  })  : randomDogImageState = InitialState(),
        _getRandomDogImageUseCase = getRandomDogImageUseCase;

  final GetRandomDogImageUseCase _getRandomDogImageUseCase;
  ...
  void generateRandomImage() async {
    ...
    final result = await _getRandomDogImageUseCase.call();
